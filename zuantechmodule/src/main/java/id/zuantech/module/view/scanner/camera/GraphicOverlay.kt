...
import id.zuantech.module.view.scanner.BarcodeGraphic
import java.util.HashSet
import java.util.Vector

class GraphicOverlay<T : BarcodeGraphic?>(context: Context?, attrs: AttributeSet?) :
//class GraphicOverlay<T : GraphicOverlay.Graphic?>(context: Context?, attrs: AttributeSet?) :
  ...
  var mGraphics: MutableSet<T> = HashSet()
